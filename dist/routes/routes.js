...
var _default = function _default(app) {
  ...
  app.get('/api/v1/car', _midleware["default"], _carControllerClass["default"].getAllCars); //route to select cars by state and status
  ...
  app.get('/api/v1/order', _midleware["default"], _carControllerClass["default"].getAllOrders); //route to select car by id

  app.get('/api/v1/car/:id', _midleware["default"], _carControllerClass["default"].specifedCar);
  app["delete"]('/api/v1/car/:id', _midleware["default"], _carControllerClass["default"].deleteCar);
